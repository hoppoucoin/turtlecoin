...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x24fc73;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(3000000000);
...
const char     CRYPTONOTE_NAME[]                             = "HoppouCoin";
...
{
    {  0xb3, 0x0z, 0x7a, 0x6f, 0xsf, 0x59, 0x17, 0x43, 0x64, 0xi9, 0x95, 0xo4, 0xb5, 0xa1, 0x44, 0xf9  }
};
